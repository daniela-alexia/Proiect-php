...
<div id="shopping-cart">
    <div class="txt-heading">
        <div class="txt-heading-label">Cos Cumparaturi</div> <a id="btnEmpty" href="cos.php?action=empty"><img src="empty.jpg"
                                                           alt="empty-cart" title="Empty Cart" width="50" height="50" /></a>
    </div>
    <?php
    ...
    if (! empty($cartItem)) {
        $item_total = 0;
        ?>
        <table cellpadding="10" cellspacing="1" class="tabel-daniela">
            <tbody>
            <tr>
                ...
                <tr>
                    ...
                    <td
                        style="text-align: center; border-bottom: #F0F0F0 1px solid;"><a href="cos.php?action=remove&id=<?php echo  $item["cart_id"]; ?>"
                            ...
                            class="btnRemoveAction"><img src="delete_cos.jpg"
                                                         alt="icon-delete" title="Remove Item" width="20" height="20" /></a></td>
                </tr>
                <?php
...
<div><a id ="id1" href="magazin.php">Alegeti alt produs</a></div>
<div><a  id ="id2" href="logout.php">Abandonati sesiunea de cumparare</a></div>
